execute if score #cat fe.data matches 1.. run scoreboard players add #pending_doom fe.data 2
execute if score #cat fe.data matches 0 run scoreboard players add #doom fe.data 2
