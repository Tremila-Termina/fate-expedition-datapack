...
execute if score #event fe.data matches 17 if score #event_elapsed fe.data matches 1 run function fate_expedition:events/storm_warn
execute if score #event fe.data matches 17 if score #event_elapsed fe.data matches 11 run function fate_expedition:events/storm_warn
execute if score #event fe.data matches 17 if score #event_elapsed fe.data matches 21 run function fate_expedition:events/storm_warn
execute if score #event fe.data matches 17 if score #event_elapsed fe.data matches 31 run function fate_expedition:events/storm_warn
execute if score #event fe.data matches 17 if score #event_elapsed fe.data matches 41 run function fate_expedition:events/storm_warn
execute if score #event fe.data matches 17 run function fate_expedition:events/storm_tick
execute if score #event fe.data matches 18 if score #event_elapsed fe.data matches 5 run function fate_expedition:events/creeper_wave
execute if score #event fe.data matches 18 if score #event_elapsed fe.data matches 20 run function fate_expedition:events/creeper_wave
execute if score #event fe.data matches 18 if score #event_elapsed fe.data matches 35 run function fate_expedition:events/creeper_wave
execute if score #event fe.data matches 21 if score #event_elapsed fe.data matches 1 run function fate_expedition:events/blaze_wave
execute if score #event fe.data matches 21 if score #event_elapsed fe.data matches 16 run function fate_expedition:events/blaze_wave
execute if score #event fe.data matches 21 if score #event_elapsed fe.data matches 31 run function fate_expedition:events/blaze_wave
execute if score #event fe.data matches 21 if score #event_elapsed fe.data matches 46 run function fate_expedition:events/blaze_wave
execute if score #event fe.data matches 22 if score #event_elapsed fe.data matches 1 run function fate_expedition:events/wither_wave
execute if score #event fe.data matches 22 if score #event_elapsed fe.data matches 16 run function fate_expedition:events/wither_wave
execute if score #event fe.data matches 22 if score #event_elapsed fe.data matches 31 run function fate_expedition:events/wither_wave
execute if score #event fe.data matches 22 if score #event_elapsed fe.data matches 46 run function fate_expedition:events/wither_wave
execute if score #event fe.data matches 25 if score #event_elapsed fe.data matches 1 run function fate_expedition:events/spider_wave
execute if score #event fe.data matches 25 if score #event_elapsed fe.data matches 16 run function fate_expedition:events/spider_wave
execute if score #event fe.data matches 25 if score #event_elapsed fe.data matches 31 run function fate_expedition:events/spider_wave
execute if score #event fe.data matches 25 if score #event_elapsed fe.data matches 46 run function fate_expedition:events/spider_wave
execute if score #event fe.data matches 26 if score #event_elapsed fe.data matches 1 run function fate_expedition:events/vindicator_wave
execute if score #event fe.data matches 26 if score #event_elapsed fe.data matches 16 run function fate_expedition:events/vindicator_wave
execute if score #event fe.data matches 26 if score #event_elapsed fe.data matches 31 run function fate_expedition:events/vindicator_wave
execute if score #event fe.data matches 26 if score #event_elapsed fe.data matches 46 run function fate_expedition:events/vindicator_wave
execute if score #event fe.data matches 29 if score #event_elapsed fe.data matches 1 run function fate_expedition:events/breath_warn
execute if score #event fe.data matches 29 if score #event_elapsed fe.data matches 11 run function fate_expedition:events/breath_warn
execute if score #event fe.data matches 29 if score #event_elapsed fe.data matches 21 run function fate_expedition:events/breath_warn
execute if score #event fe.data matches 29 if score #event_elapsed fe.data matches 31 run function fate_expedition:events/breath_warn
execute if score #event fe.data matches 29 if score #event_elapsed fe.data matches 41 run function fate_expedition:events/breath_warn
execute if score #event fe.data matches 29 run function fate_expedition:events/breath_tick
execute if score #event fe.data matches 30 if score #event_elapsed fe.data matches 1 run function fate_expedition:events/shulker_wave
execute if score #event fe.data matches 30 if score #event_elapsed fe.data matches 16 run function fate_expedition:events/shulker_wave
execute if score #event fe.data matches 30 if score #event_elapsed fe.data matches 31 run function fate_expedition:events/shulker_wave
execute if score #event fe.data matches 30 if score #event_elapsed fe.data matches 46 run function fate_expedition:events/shulker_wave
